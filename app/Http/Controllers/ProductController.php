...
//            ->get();
    ...
    public function saveProduct(Request $request)
    {
        ...
        $msgE = [
            ...
            'price.numeric' => 'Nhập vào phải là số',
...
//            'image.max' => 'Chỉ được tối đa 10MB',
        ...
        if (isset($request['image'])) {
            $rule['image'] = 'required|mimes:jpeg,jpg,png,gif|max:10000';

            $msgE['image.required'] = 'Vui lòng chọn ảnh sản phẩm';
            $msgE['image.mimes'] = 'Vui lòng chọn đúng đuôi';
            $msgE['image.max'] = 'Chỉ được tối đa 10MB';
