    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{asset('backend/index3.html')}}" class="brand-link">
            <img src="{{asset('backend/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Trang</span>
        </a>
...
{{--                </div>--}}
{{--                <div class="info">--}}
{{--                    <a href="#" class="d-block">Minh Vu</a>--}}
{{--                    --}}
{{--                </div>--}}
{{--                --}}
{{--            </div>--}}
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{URL::to('/add-brand')}}" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{URL::to('/add-product')}}" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Thêm sản phẩm</p>
                                </a>
                            </li>
...
{{--                                    <img width="100px" height="100px" src="{{asset('backend/dist/img/user2-160x160.jpg')}}" class="user-image img-circle elevation-2 alt="User Image">--}}
